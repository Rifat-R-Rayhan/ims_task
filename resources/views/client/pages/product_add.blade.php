...
<body>
    ...
    <div class="main-block">
        ...
        <form action="{{route('product_insert')}}" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="quantity" id="name" placeholder="Quantity" required autocomplete="off" />
            <span class="text text-danger">
                @error('quantity')
                    {{ $message }}
                @enderror
            ...
            <input type="text" name="price" id="name" placeholder="Price" required autocomplete="off" />
            <span class="text text-danger">
                @error('price')
                    {{ $message }}
                @enderror
